...
package me.moon.features.modules;
...
public class Module extends Feature {
   ...
   public void enable() {
      ...
      if (HUD.getInstance().notifyToggles.getValue()) {
         TextComponentString text = new TextComponentString(
            Moon.commandManager.getClientMessage() + " " + ChatFormatting.GREEN + this.getDisplayName() + " toggled on."
         );
   ...
   public void disable() {
      ...
      if (HUD.getInstance().notifyToggles.getValue()) {
         TextComponentString text = new TextComponentString(
            Moon.commandManager.getClientMessage() + " " + ChatFormatting.RED + this.getDisplayName() + " toggled off."
         );
         mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
      }
   ...
   public void setDisplayName(String name) {
      Module module = Moon.moduleManager.getModuleByDisplayName(name);
      Module originalModule = Moon.moduleManager.getModuleByName(name);
   ...
   public String getFullArrayString() {
      return this.getDisplayName()
         + ChatFormatting.GRAY
         + (this.getDisplayInfo() != null ? " [" + ChatFormatting.WHITE + this.getDisplayInfo() + ChatFormatting.GRAY + "]" : "");
   }
