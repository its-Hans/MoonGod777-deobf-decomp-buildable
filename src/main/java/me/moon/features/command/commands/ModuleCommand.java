...
public class ModuleCommand extends Command {
   ...
   public void execute(String[] commands) {
      if (commands.length == 1) {
         ...
         for(Module.Category category : Moon.moduleManager.getCategories()) {
            String modules = category.getName() + ": ";

            for(Module module1 : Moon.moduleManager.getModulesByCategory(category)) {
         ...
         Module module = Moon.moduleManager.getModuleByDisplayName(commands[0]);
         if (module == null) {
            module = Moon.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
