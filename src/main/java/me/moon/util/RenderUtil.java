...
public class RenderUtil implements Util {
   ...
   public static void drawText(BlockPos pos, String text, int color) {
      ...
      glBillboardDistanceScaled(
         (float)pos.getX() + 0.5F, (float)pos.getY() + 0.5F, (float)pos.getZ() + 0.5F, mc.player, 1.0F
      );
      GlStateManager.disableDepth();
      GlStateManager.translate(-((double)Moon.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
      Moon.textManager.drawStringWithShadow(text, 0.0F, 0.0F, color);
      GlStateManager.popMatrix();
   }
   ...
   public static void blockEsp(BlockPos blockPos, Color c, double length, double length2) {
      ...
      GL11.glColor4d((double)((float)c.getRed() / 255.0F), (double)((float)c.getGreen() / 255.0F), (double)((float)c.getBlue() / 255.0F), 0.25);
   ...
   public static void glBillboard(float x, float y, float z) {
      ...
      GlStateManager.translate(
         (double)x - mc.getRenderManager().renderPosX, (double)y - mc.getRenderManager().renderPosY, (double)z - mc.getRenderManager().renderPosZ
      );
   ...
   public static void drawOutlinedRoundedRectangle(
      int x, int y, int width, int height, float radius, float dR, float dG, float dB, float dA, float outlineWidth
   ) {
