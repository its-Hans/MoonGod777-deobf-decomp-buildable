...
public class ColorManager {
   ...
   public int getColorWithAlpha(int alpha) {
      return ClickGui.getInstance().rainbow.getValue()
         ? ColorUtil.rainbow(Component.counter1[0] * ClickGui.getInstance().rainbowHue.getValue()).getRGB()
         : ColorUtil.toRGBA(new Color(this.red, this.green, this.blue, (float)alpha / 255.0F));
   }
